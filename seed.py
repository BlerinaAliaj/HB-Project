...
if __name__ == "__main__":
    ...
    alain = User(user_id='eagle5', first_name='Alain', last_name='Rodriguez',
                 email='eagle5@gmail.com', password='alain', zipcode='94115', phone_number='12345678901')
    sofiane = User(user_id='souali', first_name='Sofiane', last_name='Ouali',
                 email='sofiane@gmail.com', password='sofiane', zipcode='94116',phone_number='12345678901' )
    henry = User(user_id='hlin', first_name='Henry', last_name='Lin',
                 email='henry@gmail.com', password='henry', zipcode='94117', phone_number='12345678901')
